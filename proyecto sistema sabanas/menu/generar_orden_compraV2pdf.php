...
if ($result) {
    ...
    // Agregar el logotipo en el borde derecho
    $logo_width = 50; // Ancho del logotipo en unidades
    $pdf->Image('../media/direccion.png', 200 - $logo_width, 10, $logo_width); // Ajusta la posición X para alinearlo a la derecha
