...
$query = "SELECT numero_pedido, departamento_solicitante, telefono, correo ,fecha_pedido, fecha_entrega_solicitada FROM cabecera_pedido_interno ORDER BY numero_pedido DESC";
