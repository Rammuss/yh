...
<head>
    ...
    <title>Registrar Presupuestos</title>
...
<div id="navbar-container"></div>
    <section class="section">
        <div class="container">
            <h1 class="title">Registrar Presupuestos</h1>
            ...
            <form id="formSolicitud">
                ...
                <div class="field">
                    <div class="control">
                        <button class="button is-primary" type="submit">Registrar Presupuesto</button>
                    </div>
    ...
    <script>
        ...
        document.getElementById("formSolicitud").addEventListener("submit", async (event) => {
            ...
            try {
                const response = await fetch('../servicios/registrar_presupuesto_servicios.php', {
                    method: 'POST',
                    headers: {
