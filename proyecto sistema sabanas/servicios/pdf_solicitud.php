    ...
    <section class="section">
        <div class="container">
            ...
            if (isset($_GET['id'])) {
                ...
                // usando COALESCE para asegurar que descuento y monto_total no sean NULL
                $sql = "
                    SELECT 
                        cab.id_cabecera, 
                        cab.fecha, 
                        cab.estado, 
                        COALESCE(cab.descuento, 0) AS descuento, 
                        COALESCE(cab.monto_total, 0) AS monto_total, 
                ...
                if (pg_num_rows($result) > 0) {
                    ...
                    <div class="box">
                        ...
                        <p><strong>Descuento:</strong> <?php echo number_format((float)$cabecera['descuento'], 2); ?></p>
                        <p><strong>Monto Total:</strong> <?php echo number_format((float)$cabecera['monto_total'], 2); ?></p>
                    </div>
                                ...
                                if (!empty($detalles)) {
                                    foreach ($detalles as $detalle) {
                                        echo "<tr>
                                                ...
                                                <td>" . number_format((float)$detalle['costo_servicio'], 2) . "</td>
                                                <td>" . number_format((float)$detalle['costo_promocion'], 2) . "</td>
                                              </tr>";
                                    }
                                }
                                ?>
