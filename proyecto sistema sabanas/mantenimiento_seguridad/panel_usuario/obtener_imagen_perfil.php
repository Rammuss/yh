...
$imagen_perfil = '/YH/proyecto sistema sabanas/mantenimiento_seguridad/panel_usuario/imagenes_perfil/default.png'; // Imagen predeterminada

if ($result && pg_num_rows($result) > 0) {
    $row = pg_fetch_assoc($result);
    if (!empty($row['imagen_perfil'])) {
        $imagen_perfil = '/YH/proyecto sistema sabanas/mantenimiento_seguridad/panel_usuario/imagenes_perfil/' . $row['imagen_perfil'];
    }
}
